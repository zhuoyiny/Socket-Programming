...
//                printf("flag The AWS: received <%d> Backend-Server <A> using UDP over port 24105\n", flag);
//
//            printf("flag A<%d>\n", flag);
//            printf("linkid A<%d>\n", linkid);
//            printf("bandwidth A<%f>\n", bandwidth);
//            printf("length A<%f>\n", length);
//            printf("velocity A<%f>\n", velocity);
//            printf("noisepower A<%f>\n", noisepower);
//
...
//            printf("flag B<%d>\n", flagB);
//            printf("linkid B<%d>\n", linkidB);
//            printf("bandwidth B<%f>\n", bandwidthB);
//            printf("length B<%f>\n", lengthB);
//            printf("velocity B<%f>\n", velocityB);
//            printf("noisepower B<%f>\n", noisepowerB);
...
//                printf( " GET transdelay: %lf\n", transdelay);
//                printf( " GET propdelay: %lf\n", propdelay);
//                printf( " GET endtoend: %lf\n", endtoend);
